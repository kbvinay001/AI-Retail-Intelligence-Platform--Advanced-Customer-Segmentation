...
def run_single_store_demo():
    ...
    print("\n📊 Dashboard saved → exports/dashboard_v3.html")

    return rip, report


def run_forecasting_demo(rip: RetailIntelligencePlatform):
    print("\n" + "═" * 60)
...
def run_ai_recommendations_demo(rip: RetailIntelligencePlatform):
    print("\n" + "═" * 60)
